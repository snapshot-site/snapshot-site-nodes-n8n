...
- the affected version of `n8n-nodes-snapshot-site`
...
Only the latest published release of [`n8n-nodes-snapshot-site`](https://www.npmjs.com/package/n8n-nodes-snapshot-site) receives security
...
The node stores its API key through the n8n credentials system, which encrypts
it at rest. Report anything that causes the key to appear in workflow output,
